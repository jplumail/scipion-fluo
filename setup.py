...
setup(
    ...
    version=get_version("pwfluo/__init__.py"),  # Required
    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description="Base pyworkflow plugin for Fluorescence image processing",  # Required
    ...
    url="https://github.com/jplumail/scipion-fluo",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Jean Plumail",  # Optional
    ...
    entry_points={
        ...
        "pyworkflow.plugin": "pwfluo = pwfluo",
    },
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/jplumail/scipion-fluo/issues",
        "Source": "https://github.com/jplumail/scipion-fluo/",
    },
)
